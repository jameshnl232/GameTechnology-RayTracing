...
public class Camera {
	...
	private int l = - MeinHyperRaytracer.resX/2;
	private int r = l * -1;
	private int t =  MeinHyperRaytracer.resY/2;
	private int b = t * -1;
	...
	private Vector3D eye = new Vector3D(0.0, 0.0, -10.0);
	...
	//
	//The variable d represents the distance from the camera's viewpoint to the image plane
	private double d = t/Math.tan(Math.PI/4)/2;
	private Vector3D w_d_negated = W.scale(d * -1);
